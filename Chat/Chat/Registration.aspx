<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ProjectWeMate.Registration" %>
     ...
     <ContentTemplate>
             ...
             <div>
                 <table class="modal-content">
                     ...
                     <tr class="form-group">
                         ...
                         <td class="auto-style14"><a href="Default.aspx">Already have a account?</a></td>
                     </tr>
                     <tr class="form-group">
         ...
         <asp:Panel ID="Panel2" runat="server" Visible="false">
             <div class="alert alert-success">
                 <asp:Label ID="ConfirmationLevel" runat="server" Text="<p style='text-align: center'>Registration Successfully Done...!!! <br /><a href='Default.aspx'>Login from here</a></p>" Visible="true" Font-Size="X-Large" Font-Bold="True"></asp:Label>
             </div>
         </asp:Panel>
     </ContentTemplate>
 </asp:updatepanel>
