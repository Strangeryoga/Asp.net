    ...
    $(document).ready(function () {
        function animateee() {
            ...
            for (i = 0; i < 500; i++) {
                ...
                $('.hhh').animate({ left: '-500px', opacity: 0 }, 0).delay(500);
                ...
                $('.hhh').animate({ left: '0px', opacity: 1 }, 1300).delay(3700);
                ...
                $('.hhh').animate({ left: '500px', opacity: 0 }, 1300).delay(1200);
...
<div id="AnimatedHeaderName">
    <span class="aaa">C</span>
    <span class="bbb">h</span>
    <span class="ccc">a</span>
    <span class="ddd">t</span>
    <span class="eee">s</span>
    <span class="fff">a</span>
    <span class="ggg">p</span>
    <span class="hhh">p</span>
