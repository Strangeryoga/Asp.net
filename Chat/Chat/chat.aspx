<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="chat.aspx.cs" Inherits="ProjectWeMate.chataspx" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentHolder" runat="Server">
    <style>
      ...
      <script>
          ...
          // Call the refreshPage function when the document is ready
          // window.onload = function () {
            //   refreshPage();
           // };
      </script>

        <asp:HiddenField ID="ScrollPositionHiddenField" runat="server" Value="0" />
        ...
        <asp:Panel runat="server" ID="chatPanel">
            <div style="vertical-align: middle; min-height: 480px;" class="pre-scrollable">
                <div>
                    ...
                    <ItemTemplate>
                        <div class="<%# GetStyleForMsgList(Eval("SenderUsername").ToString()) %> MainChatListClass">
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("SenderUsername") + ":" %>'></asp:Label>
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("MessageText")  %>'></asp:Label>
                        </div>
                    </ItemTemplate>
                    </asp:DataList>
                </div>
                     ...
                     <div>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 10%; padding-left: 9px;">
                                    <asp:Button ID="sendBTN" runat="server" Text="Send" OnClick="sendBTN_Click" CssClass="btn btn-success" Width="100%"  />
                                </td>
                                <td style="width: 10%; padding-left: 8px;">
                                    <asp:Button ID="ViewGroupChatButton" runat="server" Text="Group Chats" OnClick="ViewGroupChatButton_Click" CssClass="btn btn-info" Width="100%" />
                                </td>
                            </tr>
                        </table>
