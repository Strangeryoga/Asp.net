<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="DemoFileUpload.AdminLogin" %>
...
<body>
    <form id="form1" runat="server">
        <p>
            Email
            <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" BorderColor="Black"></asp:TextBox>
        </p>
        <p>
            Pass
